...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('new_favicon.ico') }}" type="image/x-icon">
...
<body class="bg-sec-400">
    ...
    <a href="https://www.linkedin.com/in/shivam-kumar-534715212/" target="_blank" class="text-gray-100 font-car font-medium text-5xl">
        In case of any issue contact the dev.
    </a>
</footer>
            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="rajtourandtravels8171@gmail.com" class="hover:underline "
                                        target='_blank'>Email</a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/rajtourandtravels_?igsh=b29lb2xwMDBibTY=" class="hover:underline"
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2024 <a
                            href="https://www.linkedin.com/in/shivam-kumar-534715212/" target='_blank'
                            class="hover:underline">Shivam Kumar™</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://www.linkedin.com/in/shivam-kumar-534715212/" target='_blank'
