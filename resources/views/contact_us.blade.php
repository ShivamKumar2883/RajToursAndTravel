    ...
    <div class="flex md:flex-row flex-col justify-between max-w-screen-xl md:px-16 px-8 mx-auto gap-12 ">
            ...
            <form action="#" class="space-y-8" id="contact-form">
                ...
                <div class="flex justify-between">
                    <div class="w-full mr-5">
                        ...
                        <input type="email" id="email"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="contact.email@gmail.com" required>
                    </div>
        ...
        <div class="grid mx-auto text-center gap-4 ">
            <div>
                ...
                <p class="text-sm font-light text-gray-700 font-car">Raj Tour and Travels LLC</p>
                <p class="text-sm font-light text-gray-700 font-car">Email: rajtourandtravels8171@gmail.com</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="text-sm font-light text-gray-700 font-car">Friends Colony, Rawali Mahdood, Sidcul</p>
                <p class="text-sm font-light text-gray-700 font-car">Haridwar, Uttarakhand-249402</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="font-car text-pr-400 ">+91 9555713813 and +91 8171884489</p>
            </div>
