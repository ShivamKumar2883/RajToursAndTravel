        ...
        <div class="bg-sec-100 ">
            ...
            <div class="flex justify-center md:py-28 py-12 mx-auto max-w-screen-xl">
                <div class="flex  flex-col justify-center md:w-3/5  mx-12 md:ms-20 md:mx-0">
                    <h1 class=" md:text-start text-center  font-car font-bold text-gray-900 mb-8  md:text-7xl text-4xl "><span class="text-pr-400"> WELCOME
                        </span>TO 
                        RAJ TOUR AND TRAVELS.</h1>
                    <div class="md:w-3/5 md:hidden  ">
                        <img loading="lazy" src="/images/home car.png" alt="home car">
                    </div>
                    <p class="text-justify md:mx-0 mx-8 ">Chaahe Himachal ki waadiyan ho ya Rajasthan ka rang,🛕
Har safar ke liye humare paas hai aapke liye ek perfect car.🛺
Bahut saare vehicles aur easy booking system ke saath,🕊️
Apne desh ki khoobsurati ko ab dekhiye, ab bas ek click se!📜🪶</p>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex flex-col justify-center">
                            ...
                            <p class="font-car  text-lg">Branchs</p>
                        </div>
                    </div>
                    <div
                        class="flex justify-around md:w-1/3 text-center my-4 h-16 align-middle md:border-b-0 md:border-r-2 border-b-2 pb-4 border-white">
            ...
            <div class="mx-auto max-w-screen-xl ">
                ...
                <div
                    ...
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">Comfortable Cars</h3>
                            <p class="font-car text-gray-700 text-sm "> Experience the ease of driving our comfortable cars, designed to provide a smooth and relaxing journey.</p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
            ...
            <div id="subscribe-box" style="background-color: white; color: black; padding: 30px; border-radius: 10px; max-width: 400px; margin: 0 auto; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    <h2 style="text-align: center; font-size: 24px; margin-bottom: 20px;">Subscribe to Our Newsletter</h2>
    <p style="text-align: center; margin-bottom: 20px;">Get the latest updates, promotions, and news about Raj Tour and Travels delivered to your inbox.</p>
    <form id="subscribe-form" action="#" method="POST" style="display: flex; flex-direction: column; align-items: center;">
        <input type="email" name="email" placeholder="Enter your email address" required style="padding: 10px; width: 100%; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px;">
        <button type="submit" style="background-color: black; color: white; padding: 12px 20px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; width: 100%; transition: background-color 0.3s;">
            Subscribe
        </button>
    </form>
    <div id="subscribed-message" style="display: none; color: #28a745; font-size: 18px; text-align: center; margin-top: 20px; opacity: 0; transition: opacity 0.5s;">
        Subscribed! 🎉
    </div>
</div>
...
document.getElementById("subscribe-form").addEventListener("submit", function(event) {
    ...
    setTimeout(() => { message.style.opacity = 1; }, 10); // Fades in the message
    
    // Optional: Hide the form after showing the message
